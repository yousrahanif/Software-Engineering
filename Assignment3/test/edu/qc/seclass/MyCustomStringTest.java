...
public class MyCustomStringTest {
	...
	public void testCountNumbers3() {
		mycustomstring.setString("5h0u1d 1 g0 t0 a r1d3");// 5,0,1,1,0,0,1,3
		assertEquals(8, mycustomstring.countNumbers());
	}

	@Test
	public void testCountNumbers4() {
		mycustomstring.setString("br0 13t m3 3at b33f");// 0,13,3,3,33
		assertEquals(5, mycustomstring.countNumbers());
	}

	@Test
	public void testCountNumbers5() {
		mycustomstring.setString("y0ur ar3 g00d");// 0,3,00
		assertEquals(3, mycustomstring.countNumbers());
	}

	@Test
	public void testCountNumbers6() {
		mycustomstring.setString("k33p qui3t.");// 33,3
	...
	public void testGetEveryNthCharacterFromBeginningOrEnd3() {
		...
		assertEquals("HlM", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(3, true));
	}

	@Test
	public void testGetEveryNthCharacterFromBeginningOrEnd4() {
		mycustomstring.setString("I love you");
		assertEquals("Ie", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(5, true));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testGetEveryNthCharacterFromBeginningOrEnd5() {
		mycustomstring.setString("I am very tired with my life. I want a break from it ASAP");
		assertEquals("IllegalArgumentException", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(-5, false));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testGetEveryNthCharacterFromBeginningOrEnd6() {
		mycustomstring.setString("There can be only one winner, Let's go");
		assertEquals("IllegalArgumentException", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(-7, false));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testGetEveryNthCharacterFromBeginningOrEnd7() {
		mycustomstring.setString("I want to be a professor. So I will be paid as I am increasing my knowledge");
		assertEquals("IllegalArgumentException", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(-9, false));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testGetEveryNthCharacterFromBeginningOrEnd8() {
		mycustomstring.setString("I want to live with my parents forever");
		assertEquals("IllegalArgumentException", mycustomstring.getEveryNthCharacterFromBeginningOrEnd(0, false));
	}
